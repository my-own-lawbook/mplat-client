...
import me.bumiller.civoris.feature.auth.navigation.EmailScreen
import me.bumiller.civoris.feature.auth.screen.SignupStageViewmodel
    ...
    private suspend fun EmailUiEvent.Continue.handle() {
        ...
        when (response) {
            ...
            is AuthResult.Error -> when (response.errorType) {
                SubmitEmailTokenError.InvalidToken -> updateUiState<EmailState> {
