package me.bumiller.civoris.feature.onboarding.navigation
...
import me.bumiller.civoris.feature.onboarding.screen.design.DesignScreen
import me.bumiller.civoris.feature.onboarding.screen.url.UrlScreen

/**
 * Navigation destination for the whole onboarding location.
 */
@Serializable
data class OnboardingLocation(

    /**
     * Whether to also show the design screen.
     */
 ...
 */
@Serializable
internal data object UrlScreen

/**
 * Navigation destination for the design-screen.
 */
@Serializable
internal data object DesignScreen
 ...
 */
fun NavGraphBuilder.onboardingLocation(
    onOnboardingFinished: () -> Unit
) = composable<OnboardingLocation> {
    val args = it.toRoute<OnboardingLocation>()
    ...
    Surface(
        ...
        NavHost(
            ...
            urlScreen(
                onUrlSet = {
                    if (args.showDesignScreen) {
                        navController.navigate(DesignScreen)
                    } else {
