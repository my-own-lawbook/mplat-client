 ...
 */
tasks.register("civorisLicenseReport") {
    description =
        "Copies the license-file generated by the 'licenseReleaseReport' to the 'composeResources' directory, so it can be used from compose code. Also deletes directories that would otherwise cause issues."
